...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        String hostname = "kafka-es-twitter-6560231012.us-east-1.bonsaisearch.net";
        String username = "oaxytmz7xj";
        String password = "t9k2219c46";
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true){
            ...
            String filename = "C:\\RS\\Courses\\Kafka\\twitter_files\\file1.json";
            for(ConsumerRecord<String, String> record : records){
                ...
                try {
                    ...
                    IndexRequest request = new IndexRequest("twitter", "tweets"
                            , id // to make idempotent
                    ).source(record.value(), XContentType.JSON);
                    bulkRequest.add(request);
                    obj.put(id,record.value());

                    ////Not required because we are going to do it using bulk request
